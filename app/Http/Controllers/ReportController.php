...
class ReportController extends Controller
{
    ...
    public function getDailyReport(Request $request)
    {
        ...
        $sell_details =  Transaction::leftjoin('transaction_sell_lines', 'transactions.id', 'transaction_sell_lines.transaction_id')
            ...
            ->select(
                ...
                DB::raw('(SUM(transaction_sell_lines.quantity  * transaction_sell_lines.unit_price_inc_tax)-transaction_sell_lines.line_discount_amount) as total_amount'),
        ...
        // outstanding received
        $total_received_outstanding_ra = $this->getTotalReceivedOutstandingRa($business_id, $start_date, $end_date, $location_id, false);
        ...
        $total_out = $shortage_total + $expense_in_settlement;
    ...
    public function getMonthlyReport(Request $request, $is_previous = false)
    {
        ...
        foreach ($period as $date) {
            ...
            */
            ...
            $credit_received_payments[$date]->cash = $cash_account_group != null? Account::getAccountGroupBalanceByType($cash_account_group->id, "credit", $account_group_balance_report_date, $account_group_balance_report_date, $is_previous) : 0;
            $credit_received_payments[$date]->cheque = $cheque_account_group != null? Account::getAccountGroupBalanceByType($cheque_account_group->id, "credit", $account_group_balance_report_date, $account_group_balance_report_date, $is_previous) : 0;
            $credit_received_payments[$date]->credit_card = $card_account_group != null? Account::getAccountGroupBalanceByType($card_account_group->id, "credit", $account_group_balance_report_date, $account_group_balance_report_date, $is_previous) : 0;
    ...
    public function getPrevioudDayBalance($start_date, $end_date, $location_id)
    {
        ...
        $received['credit_sale'] = Account::getAccountBalanceByType($receiveable_account_id, 'debit', $start_date, $end_date, true)
        -Account::getAccountBalanceByType($receiveable_account_id, 'credit', $start_date, $end_date, true, "ledger_show") + $credit_sale_ob;
