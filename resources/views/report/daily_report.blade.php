                    ...
                    <table class="table table-bordered table-striped" id="sale_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{@num_format($sale->dicount_given)}}</td>
                            ...
                            <tr>
                                ...
                                <td>{{@num_format($petro_sale->dicount_given)}}</td>
                            ...
                            <tr>
                                ...
                                <td >{{@num_format($dicount_given)}}</td>
                            ...
                            <table class="table table-bordered table-striped" id="daily_report_table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{@num_format($total_received_outstanding_ra)}}</td>
                                    </tr>
                                    <tr>
