        ...
        <table class="table table-border table-striped">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="amount-text"><b>{{@num_format(@$lt_liabilities_accounts->sum('balance') +  @$lt_liabilities_accounts_main_balances_total + @$liabilities_accounts->sum('balance') + @$liabilities_accounts_main_balances_total + @$tl_equity_accounts_main_balances)}}</b></td>
                </tr>
                @endif
            </tbody>
