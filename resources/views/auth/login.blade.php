                    ...
                    <div class="col-md-8 intro-cont center">
                        ...
                        <div class="row">
                            <div class="col-md-2 center"> 
                                @if(!empty($login_vehicle_registration))
                                <button style=" width: 150px; height: 150px; padding: 10px 8px; font-size: 14px; border-radius: 80px;"class="btn btn-danger" type="button" data-toggle="modal" data-target="#vehical_registration_modal">     
                                    Click here to<br> Register<br> Your Vehical 
                                </button>
                                @endif  
                            </div>          
                           <!-- Modal -->
                           @if(!empty($login_vehicle_registration))
                            ...
                            <div class="modal fade" id="vehical_registration_modal" role="dialog" aria-labelledby="exampleModalLabel"                           aria-hidden="true">
...
<!-- Modal -->
<div class="modal fade" id="vehical_registration_modal" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document" id="vehical_registration_dialog" style="width: 55%;">
        <div class="modal-content">
            <div class="modal-body">
