...
function updateProfitLoss(start = null, end = null, location_id = null) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var netProfit = (data.total_sell - parseFloat(data.total_sale_cost) - data.direct_expense_balance) - data.total_expense;
            ...
            pl_span.find('.gross_profit').html(__currency_trans_from_en(((data.total_sell - data.total_sale_cost) - data.direct_expense_balance), true));
